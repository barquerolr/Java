...
public class ProductArrays23
{
  public static void main(String args[])
  {
    ...
    if (d >= 0)   System.out.println("The product ID is: "+d);
                  System.out.println("The price of the product is:$" +price[d]);
                  System.out.println("The quantity of the product is: "+quantity[d]);
